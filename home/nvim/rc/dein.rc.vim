...
call map(g:dein#inline_vimrcs, "resolve(g:base_dir .. v:val)")

if dein#min#load_state(s:dein_dir) 
  let s:toml = g:base_dir .. 'dein.toml'
  let s:toml_lazy = g:base_dir .. 'dein_lazy.toml'
  let s:toml_denops = g:base_dir .. 'denops.toml'
  let s:toml_ddc = g:base_dir .. 'ddc.toml'
  let s:toml_ddu = g:base_dir .. 'ddu.toml'
  let s:toml_ft = g:base_dir .. 'dein_ft.toml'

  call dein#begin(s:dein_dir)
  call dein#load_toml(s:toml, #{lazy: 0})
  call dein#load_toml(s:toml_lazy, #{lazy: 1})
  call dein#load_toml(s:toml_denops, #{lazy: 1})
